...
def main(args):
    ...
    #   读取数据集对应的txt
    # ---------------------------#
    with open(os.path.join(VOCdevkit_path, "SUIM2022/ImageSets/Segmentation/train.txt"), "r") as f:
        train_lines = f.readlines()
    with open(os.path.join(VOCdevkit_path, "SUIM2022/ImageSets/Segmentation/val.txt"), "r") as f:
...
def parse_args():
    ...
    parser.add_argument('--init-epoch', default=0, type=int, metavar='N',
                        help='init epoch')

    # ---------- optimizer params ----------
    parser.add_argument('--init-lr', default=1e-2, type=float, help='initial learning rate')
