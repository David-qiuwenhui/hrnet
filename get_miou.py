...
if __name__ == "__main__":
    ...
    #   默认指向根目录下的VOC数据集
    # -------------------------------------------------------#
    VOCdevkit_path = '../../dataset/SUIMdevkit'

    image_ids = open(os.path.join(VOCdevkit_path, "SUIM2022/ImageSets/Segmentation/val.txt"), 'r').read().splitlines()
    gt_dir = os.path.join(VOCdevkit_path, "SUIM2022/SegmentationClass/")
    ...
    if miou_mode == 0 or miou_mode == 1:
        ...
        for image_id in tqdm(image_ids):
            image_path = os.path.join(VOCdevkit_path, "SUIM2022/JPEGImages/" + image_id + ".jpg")
